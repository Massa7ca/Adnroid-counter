...
/**
 * A simple implementation of {@link javax.script.ScriptContext}.
 * 
...
public class SimpleScriptContext implements javax.script.ScriptContext {
     ...
     * */
    protected javax.script.Bindings globalScope = null;

    /**
     * This is the scope bindings for ENGINE_SCOPE .
     * By default, a SimpleBindings is used.
     */
    protected javax.script.Bindings engineScope = new SimpleBindings();
