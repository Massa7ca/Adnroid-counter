...
public class ScriptEngineManager {
    ...
    private javax.script.Bindings globalscope = new SimpleBindings();
    ...
    public ScriptEngineManager(ClassLoader loader) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD) {
            iterator = ServiceLoader.load(javax.script.ScriptEngineFactory.class, loader).iterator();
        } else {
            iterator = ServiceRegistry.lookupProviders(javax.script.ScriptEngineFactory.class, loader);
        }

        while (iterator.hasNext()) {
            javax.script.ScriptEngineFactory factory;
            try {
                factory = (javax.script.ScriptEngineFactory) iterator.next();
    ...
    public javax.script.ScriptEngine getEngineByExtension(String extension){
        ...
        javax.script.ScriptEngineFactory factory =
                (javax.script.ScriptEngineFactory) extensionAssociations.get(extension);

        if (factory != null) {
            // gets a new instance of the Scripting Engine
            engine = factory.getScriptEngine();
            // sets the GLOBAL SCOPE
            engine.setBindings(globalscope, javax.script.ScriptContext.GLOBAL_SCOPE);
        }
    ...
    public javax.script.ScriptEngine getEngineByMimeType(String mimeType){
        ...
        javax.script.ScriptEngine engine = null;
        javax.script.ScriptEngineFactory factory =
                (javax.script.ScriptEngineFactory) mimeTypeAssociations.get(mimeType);
    ...
    public javax.script.ScriptEngine getEngineByName(String shortName){
        ...
        javax.script.ScriptEngine engine = null;
        javax.script.ScriptEngineFactory factory =
                (javax.script.ScriptEngineFactory) nameAssociations.get(shortName);
